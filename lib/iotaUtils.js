...
/**
 * Retrieve a device from the device repository based on the given APIKey and DeviceID. MQTT state topics do not
 * include an API key, so an empty key must resolve an already provisioned globally unique Device ID and must never
 * create a second device in the default service.
 *
