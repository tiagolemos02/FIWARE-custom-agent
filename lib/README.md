...
`../docker/Dockerfile` now builds the checked-out repository instead of downloading a GitHub branch. It pins `iotagent-node-lib` to commit `78ad1289f5b4b3c1b611cae07d295f091e04788b`, which is compatible with the retained Node 16 runtime.
